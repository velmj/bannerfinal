...
const stats = [
  { name: 'Successs Rate', stat: '88.16%', previousStat: '76.14%', change: '15.11%', changeType: 'increase' },
  { name: 'Average Time', stat: '2.57 hrs', previousStat: '2.86 hrs', change: '4.05%', changeType: 'decrease' },
  { name: 'Total Rows', stat: '71,897', previousStat: '70,946', change: '12%', changeType: 'increase' }
]
